const alimentaRel = (relatorio) => {
	...
	for (t in relatorio) {
		...
		${timeStop}
		<td class="text-sm-center align-middle"><button class="btn btn-primary teste" onClick="teste(window.location.href = '../index.html?idMaquina=${relatorio[t].id_equipamento}')">
